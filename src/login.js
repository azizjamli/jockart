                    ...
                    {isSignUp ? (
                        ...
                        <div className="signin p-5">
                            ...
                            <form className="d-flex flex-column align-items-center gap-3">
                                <input className="mt-4" type="email" id="tel" placeholder="Email" />
                                <input className="mt-4" type="password" id="tel" placeholder="Mot de passe" />
                ...
                <div className={`col-md-6 ${isSignUp ? 'order-md-1 slide-in-left' : 'order-md-2 slide-in-right'}`}>
                    {isSignUp ? (
                        <div className="signintogglediv p-5 d-flex flex-column align-items-center gap-5">
                            ...
                            <button className="btn mt-5 float-left" onClick={toggleSignUp}>Se connecter</button>
                        </div>
                    ) : (
                        <div className="signintogglediv p-5 d-flex flex-column align-items-center gap-5">
                            ...
                            <button className="btn mt-5 float-right" onClick={toggleSignUp}>S'inscrire</button>
                        </div>
                    )}
                </div>
            </div>
